package com.danny.javablogaggregatorspringboot;
...
@EnableCaching
@EnableScheduling
public class JavaBlogAggregatorSpringBootApplication {

    public static void main(String[] args) {
        SpringApplication.run(JavaBlogAggregatorSpringBootApplication.class, args);
    }
    ...
    public CacheManager cacheManager() {
        ...
        cacheManager.setCaches(Arrays.asList(
                new ConcurrentMapCache("icons"),
                new ConcurrentMapCache("configuration"),
