package com.danny.microservices.currencyconversionservice;
...
public class CurrencyConversionBean {
    ...
    public CurrencyConversionBean(String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalculatedAmount) {
        this.from = from;
        this.to = to;
        this.conversionMultiple = conversionMultiple;
        this.quantity = quantity;
